...
export const ShowOneRecipe = () => {
    ...
    if (rec._id === id) {
      return (
        <article className="oneRecipe-wrapper" key={index}>
          <div className="desktop-container-title">
          ...
          <div className="desktop-container-img-desc-ing">
            <section className="oneRecipe-wrapper-img">
  ...
  return (
    <>
      <div className="one-recipe-wrapper-content">{oneRecipe}</div>
    </>
  );
};
